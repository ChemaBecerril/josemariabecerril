        ...
        <div className="inner">
          ...
          <div className="grid-wrapper">
            <div className="col-6">
              ...
              <p>In addition to my academic work, I have also written ethnographic research intended for public audiences in publications such as Nexos, Jacobin, Pie de Página, and Horizontal.</p>
